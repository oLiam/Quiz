...
@parent
    ...
    {{ Form::open(array('url'=>'quizzes/create', 'class' => 'createquiz')) }}
        ...
        <p>Question 1</p>{{ Form::text('quizname', null, array('required','placeholder' => 'Question 1', 'size' => '40')) }}
        <p>Question 2</p>{{ Form::text('quizname', null, array('required','placeholder' => 'Question 2', 'size' => '40')) }}
